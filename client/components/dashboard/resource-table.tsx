...
export default function ResourceTable() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 w-full">
      <div className={`transition-all duration-500 ease-in-out ${detailsVisible ? "w-full lg:w-3/5" : "w-full max-w-4xl mx-auto"
        }`}>
            ...
            <div className="px-6 py-3 bg-neutral-800/50 border-b border-neutral-800 flex flex-wrap items-center gap-3">
              <div className="flex gap-2">
                ...
                <Button
                  size="sm"
                  variant="ghost"
                  className={`px-3 py-1 rounded-md text-sm ${statusFilter === "published"
                ...
                <Button
                  size="sm"
                  variant="ghost"
                  className={`px-3 py-1 rounded-md text-sm ${statusFilter === "awaiting"
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredResources.map((resource) => (
                      <TableRow
                        key={resource.id}
                        className={`!border-0 cursor-pointer hover:bg-neutral-800/70 transition-colors ${selectedResource?.id === resource.id
                      ...
                      >
                        ...
                        <TableCell>
                          <span className={`px-3 py-1 rounded-full text-xs font-medium ${resource.status === "published"
                              ? "bg-emerald-500/20 text-emerald-300 ring-1 ring-emerald-500/30"
                              : "bg-amber-500/20 text-amber-300 ring-1 ring-amber-500/30"
                            }`}>
                            {resource.status}
      ...
      {selectedResource && (
        <div className={`w-full lg:w-2/5 transition-all duration-500 ease-in-out transform ${detailsVisible ? "translate-x-0 opacity-100" : "translate-x-full opacity-0 absolute right-0"
          }`}>
